...
# Built in Data - status_tables
- examples from actual clinical trials, numbered by # of arms
...
- Calculates start, end of each line 
...
- Helper functions to take standard data formats and make a status_table from:
  ...
  + ADaM data format?
- See if this works outside of MacOS/RStudio Graphics Device?
